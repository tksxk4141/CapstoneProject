...
public class cshLauncher : MonoBehaviourPunCallbacks
{
    ...
    {
        cshLobbyManager.Instance.OpenMenu("title");//로비에 들어오면 타이틀 메뉴 키기
    ...
    public void CreateRoom()//방만들기
    {
        ...
        cshLobbyManager.Instance.OpenMenu("loading");//로딩창 열기
    }

    public override void OnJoinedRoom()//방에 들어갔을때 작동
    {
        cshLobbyManager.Instance.OpenMenu("room");//룸 메뉴 열기
    ...
    {
        cshLobbyManager.Instance.OpenMenu("title");//방떠나기 성공시 타이틀 메뉴 호출
    }
